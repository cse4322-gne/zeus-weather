      ...
      <div className="auth-container">
        <div className="auth-card">
          <div className="auth-header">
            ...
            <p className="auth-subtitle">Log in to view Zeus Weather</p>
          </div>
          ...
          <form className="auth-form" onSubmit={handleLogin}>
            ...
            <button className="auth-button" type="submit" disabled={loading}>
              {loading ? <Loader2 className="animate-spin" size={22} /> : 'Enter the Storm'}
            </button>
          </form>

          <div className="auth-footer">
            Don't have an account? <Link to="/signup" className="auth-link">Summon one</Link>
          </div>
        </div>
      </div>
    </div>
